                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="text-align: -webkit-center;margin-top: 20px;">
                                                                                        <span>
                                                                                            <a href="http://dkpm.com/hZGK2g0cpu/yX9lCJtLcW?ALXEjY8McZ='.$access_token.'" target="_blank" style="background-color: #973c35;text-decoration: none;color: #fff;padding: 10px;font-size: 23px;border-radius: 7px;">Activate Account</a>
                                                                                        </span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        ...
                                                                        <table style="margin-top:50px;">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="margin-top: 20px;">
                                                                                        <span>
                                                                                            <a href="http://dkpm.com/hZGK2g0cpu/yX9lCJtLcW?ALXEjY8McZ='.$access_token.'" target="_blank">http://dkpm.com/hZGK2g0cpu/yX9lCJtLcW?ALXEjY8McZ='.$access_token.'</a>
                                                                                        </span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
