                                                                    ...
                                                                    <td>
                                                                        <table>
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <p>Since you have forgotten your password, please change your password as soon as possible due to security concerns. Please use the new password to log in to the system.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td style="text-align: -webkit-center;margin-top: 20px;">
                                                                                        <span>
                                                                                            <a href="http://dkpm.com/sjgfW6qC03?tGjsGRc7ge='.$access_token.'" target="_blank" style="background-color: #973c35;text-decoration: none;color: #fff;padding: 10px;font-size: 23px;border-radius: 7px;">Reset Password</a>
                                                                                        </span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        ...
                                                                        <table style="margin-top:50px;">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="margin-top: 20px;">
                                                                                        <span>
                                                                                            <a href="http://dkpm.com/sjgfW6qC03?tGjsGRc7ge='.$access_token.'" target="_blank">http://dkpm.com/sjgfW6qC03?tGjsGRc7ge='.$access_token.'</a>
                                                                                        </span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                                    ...
                                                                                    <td style="text-align: -webkit-center;">
                                                                                        <table>
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                <td>
                                                                                                <a href="https://www.facebook.com/sharer/sharer.php?u=http://dkpm.com" target="_blank"><img title="Facebook" src="cid:facebook" alt="Fb" width="32" height="32"></a>
                                                                                            </td>
                                                                                            <td>
                                                                                                <a href="https://twitter.com/intent/tweet?url=http://dkpm.com" target="_blank"><img title="Twitter" src="cid:twitter" alt="Tw" width="32" height="32"></a>
                                                                                            </td>
                                                                                            <td>
                                                                                                <a href="https://www.linkedin.com/sharing/share-offsite/?url=http://dkpm.com" target="_blank"><img title="Linkedin" src="cid:linkedin" alt="Yt" width="32" height="32"></a>
                                                                                            </td>
                                                                                            <td>
                                                                                                <a href="https://www.pinterest.com/pin/create/link/?url=http://dkpm.com" target="_blank"><img title="Pinterest" src="cid:pinterest" alt="P" width="32" height="32"></a>
                                                                                            </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
